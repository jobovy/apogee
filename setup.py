...
setup(name='apogee',
      ...
      package_data={'apogee/samples':['data/rcmodel_mode_jkz_ks_parsec_newlogg.sav',
		    ...
		    'apogee/tools':['obslogs/obs-summary-year6-north.csv',
				    'obslogs/obs-summary-year6-south.csv',
				    'obslogs/obs-summary-year6.csv',
				    'obslogs/obs-summary-year45.csv',
   				    'obslogs/obs-summary-year123.csv']},
